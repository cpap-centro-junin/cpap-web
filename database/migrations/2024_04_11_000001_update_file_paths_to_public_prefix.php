...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        // Actualizar configuracion_inicio - hero_imagen
        DB::statement(<<<SQL
        ...
        // Actualizar recursos_biblioteca - archivo_pdf
        DB::statement(<<<SQL
            UPDATE recursos_biblioteca 
            SET archivo_pdf = CONCAT('public/', archivo_pdf) 
            WHERE archivo_pdf IS NOT NULL 
            AND archivo_pdf != '' 
            AND NOT archivo_pdf LIKE 'public/%'
        ...
        // Actualizar recursos_biblioteca - imagen_portada
        DB::statement(<<<SQL
            UPDATE recursos_biblioteca 
            SET imagen_portada = CONCAT('public/', imagen_portada) 
            WHERE imagen_portada IS NOT NULL 
    ...
    public function down(): void
    {
        ...
        // Revertir recursos_biblioteca - archivo_pdf
        DB::statement("UPDATE recursos_biblioteca SET archivo_pdf = SUBSTRING(archivo_pdf, 8) WHERE archivo_pdf LIKE 'public/%'");

        // Revertir recursos_biblioteca - imagen_portada
        DB::statement("UPDATE recursos_biblioteca SET imagen_portada = SUBSTRING(imagen_portada, 8) WHERE imagen_portada LIKE 'public/%'");
