...
class ColegiadoController extends Controller
{
    ...
    private function validationRules(int $excludeId = 0, bool $forCreate = false): array
    {
        $rules = [
            ...
            'especializacion_detalle' => 'nullable|string',
            'diplomados'         => 'nullable|string',
            'experiencia_anos'   => 'nullable|integer|min:0|max:50',
            'experiencia_sector' => 'nullable|in:publica,privada,mixta',
    ...
    private function resolveVisibilityFields(Request $request): array
    {
        return [
            ...
            'ocultar_grado_academico'   => $request->boolean('ocultar_grado_academico'),
            'ocultar_especializacion_detalle' => $request->boolean('ocultar_especializacion_detalle'),
            'ocultar_diplomados'        => $request->boolean('ocultar_diplomados'),
            'ocultar_experiencia'       => $request->boolean('ocultar_experiencia'),
