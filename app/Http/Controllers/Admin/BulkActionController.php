...
class BulkActionController extends Controller
{
    ...
    private function deleteSimple($table, $ids)
    {
        match($table) {
            ...
            'invitaciones' => \App\Models\Invitaciones::whereIn('id', $ids)->delete(),
    ...
    private function activateAction($table, $ids)
    {
        match($table) {
            ...
            'invitaciones' => \App\Models\Invitaciones::whereIn('id', $ids)->update(['usado' => false]),
    ...
    private function deactivateAction($table, $ids)
    {
        match($table) {
            ...
            'invitaciones' => \App\Models\Invitaciones::whereIn('id', $ids)->update(['usado' => true]),
