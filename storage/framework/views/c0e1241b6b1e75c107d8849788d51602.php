<?php $__env->startSection('title', 'Editar Recurso Bibliográfico'); ?>
<?php $__env->startSection('page-title', 'Editar Recurso Bibliográfico'); ?>
...
<div style="width:100%;">
    ...
    <div style="display:flex;align-items:center;gap:14px;margin-bottom:24px;">
        <a href="<?php echo e(route('admin.biblioteca.index')); ?>"
        ...
        <div>
            ...
            <p style="color:var(--medium-gray);font-size:13px;margin:0;"><?php echo e($recurso->titulo); ?></p>
        </div>
    </div>
    ...
    <form action="<?php echo e(route('admin.biblioteca.update', $recurso)); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
            ...
            <div>
                ...
                <div class="admin-card" style="margin-bottom:16px;">
                    ...
                    <div style="margin-bottom:14px;">
                        ...
                        <input type="text" name="titulo" value="<?php echo e(old('titulo', $recurso->titulo)); ?>"
                    ...
                    <div style="display:grid;grid-template-columns:1fr 1fr;gap:14px;margin-bottom:14px;">
                        <div>
                            ...
                            <input type="text" name="autor" value="<?php echo e(old('autor', $recurso->autor)); ?>"
                                   class="admin-input" required>
                        </div>
                        <div>
                            <label style="display:block;font-size:13px;font-weight:600;color:var(--dark);margin-bottom:6px;">Editorial</label>
                            <input type="text" name="editorial" value="<?php echo e(old('editorial', $recurso->editorial)); ?>"
                                   class="admin-input">
                        </div>
                    </div>
                    <div style="margin-bottom:14px;">
                        ...
                        <textarea name="descripcion" rows="5"
                                  class="admin-input" required><?php echo e(old('descripcion', $recurso->descripcion)); ?></textarea>
                    </div>
                    <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:14px;">
                        <div>
                            ...
                            <input type="number" name="anio_publicacion" value="<?php echo e(old('anio_publicacion', $recurso->anio_publicacion)); ?>"
                                   min="1900" max="<?php echo e(date('Y') + 1); ?>" class="admin-input">
                        </div>
                        <div>
                            <label style="display:block;font-size:13px;font-weight:600;color:var(--dark);margin-bottom:6px;">ISBN / ISSN</label>
                            <input type="text" name="isbn_issn" value="<?php echo e(old('isbn_issn', $recurso->isbn_issn)); ?>"
                                   class="admin-input">
                        </div>
                        <div>
                            <label style="display:block;font-size:13px;font-weight:600;color:var(--dark);margin-bottom:6px;">Páginas</label>
                            <input type="number" name="paginas" value="<?php echo e(old('paginas', $recurso->paginas)); ?>"
                ...
                <div class="admin-card" style="margin-bottom:16px;">
                    ...
                    <div style="display:flex;gap:16px;margin-bottom:14px;flex-wrap:wrap;">
                        ...
                        <div style="display:flex;align-items:center;gap:10px;padding:10px 14px;background:rgba(139,21,56,0.08);border:1px solid rgba(139,21,56,0.15);border-radius:8px;font-size:12px;">
                            ...
                            <div style="flex:1;">
                                ...
                                <div style="color:var(--medium-gray);font-size:11px;margin-top:2px;"><?php echo e(basename($recurso->archivo_pdf)); ?></div>
                            </div>
                            <a href="<?php echo e(route('admin.biblioteca.descargar-pdf', $recurso)); ?>" target="_blank"
                    ...
                    <div style="display:grid;grid-template-columns:1fr 1fr;gap:14px;">
                        <div>
                            ...
                            <input type="url" name="enlace_externo" value="<?php echo e(old('enlace_externo', $recurso->enlace_externo)); ?>"
                                   class="admin-input">
                        </div>
                        <div>
                            <label style="display:block;font-size:13px;font-weight:600;color:var(--dark);margin-bottom:6px;">Idioma</label>
                            <input type="text" name="idioma" value="<?php echo e(old('idioma', $recurso->idioma)); ?>"
                                   class="admin-input">
                        </div>
                    </div>
                </div>
                ...
                <div class="admin-card" style="margin-bottom:16px;border-left:4px solid var(--secondary);">
                    ...
                    <div style="display:grid;grid-template-columns:1fr 1fr;gap:14px;margin-bottom:14px;">
                        <div>
                            ...
                            <input type="text" name="copyright_titular" value="<?php echo e(old('copyright_titular', $recurso->copyright_titular)); ?>"
                                   class="admin-input">
                        </div>
                        <div>
                            <label style="display:block;font-size:13px;font-weight:600;color:var(--dark);margin-bottom:6px;">Año del copyright</label>
                            <input type="number" name="copyright_anio" value="<?php echo e(old('copyright_anio', $recurso->copyright_anio)); ?>"
                                   min="1900" max="<?php echo e(date('Y') + 1); ?>" class="admin-input">
                        </div>
                    </div>
                    ...
                    <div style="margin-bottom:14px;">
                        ...
                        <select name="licencia_tipo" class="admin-input" required>
                            <optgroup label="Derechos Reservados">
                                <option value="copyright" <?php echo e(old('licencia_tipo', $recurso->licencia_tipo)=='copyright'?'selected':''); ?>>© Todos los derechos reservados</option>
                            </optgroup>
                            <optgroup label="Creative Commons">
                                <option value="creative_commons_by" <?php echo e(old('licencia_tipo', $recurso->licencia_tipo)=='creative_commons_by'?'selected':''); ?>>CC BY — Atribución</option>
                                <option value="cc_by_sa" <?php echo e(old('licencia_tipo', $recurso->licencia_tipo)=='cc_by_sa'?'selected':''); ?>>CC BY-SA — Atribución-CompartirIgual</option>
                                <option value="cc_by_nc" <?php echo e(old('licencia_tipo', $recurso->licencia_tipo)=='cc_by_nc'?'selected':''); ?>>CC BY-NC — Atribución-NoComercial</option>
                                <option value="cc_by_nc_sa" <?php echo e(old('licencia_tipo', $recurso->licencia_tipo)=='cc_by_nc_sa'?'selected':''); ?>>CC BY-NC-SA — Atrib-NoCom-CompartirIgual</option>
                                <option value="cc_by_nd" <?php echo e(old('licencia_tipo', $recurso->licencia_tipo)=='cc_by_nd'?'selected':''); ?>>CC BY-ND — Atribución-SinDerivadas</option>
                                <option value="cc_by_nc_nd" <?php echo e(old('licencia_tipo', $recurso->licencia_tipo)=='cc_by_nc_nd'?'selected':''); ?>>CC BY-NC-ND — Atrib-NoCom-SinDerivadas</option>
                            </optgroup>
                            <optgroup label="Otros">
                                <option value="dominio_publico" <?php echo e(old('licencia_tipo', $recurso->licencia_tipo)=='dominio_publico'?'selected':''); ?>>Dominio Público</option>
                                <option value="licencia_cpap" <?php echo e(old('licencia_tipo', $recurso->licencia_tipo)=='licencia_cpap'?'selected':''); ?>>Licencia CPAP — Uso institucional</option>
                            </optgroup>
                        </select>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="notas_legales" rows="3"
                                  class="admin-input"><?php echo e(old('notas_legales', $recurso->notas_legales)); ?></textarea>
                    </div>
                </div>
            </div>
                ...
                <div class="admin-card" style="margin-bottom:16px;">
                    ...
                    <div style="margin-bottom:12px;">
                        ...
                        <select name="tipo" class="admin-input" required>
                            <option value="libro" <?php echo e(old('tipo', $recurso->tipo)=='libro'?'selected':''); ?>>Libro</option>
                            <option value="articulo" <?php echo e(old('tipo', $recurso->tipo)=='articulo'?'selected':''); ?>>Artículo</option>
                            <option value="tesis" <?php echo e(old('tipo', $recurso->tipo)=='tesis'?'selected':''); ?>>Tesis</option>
                            <option value="documento" <?php echo e(old('tipo', $recurso->tipo)=='documento'?'selected':''); ?>>Documento CPAP</option>
                            <option value="revista" <?php echo e(old('tipo', $recurso->tipo)=='revista'?'selected':''); ?>>Revista</option>
                            <option value="multimedia" <?php echo e(old('tipo', $recurso->tipo)=='multimedia'?'selected':''); ?>>Multimedia</option>
                        </select>
                    </div>
                    <div style="margin-bottom:12px;">
                        ...
                        <select name="formato" class="admin-input" required>
                            <option value="digital" <?php echo e(old('formato', $recurso->formato)=='digital'?'selected':''); ?>>💻 Virtual (Digital)</option>
                            <option value="fisico" <?php echo e(old('formato', $recurso->formato)=='fisico'?'selected':''); ?>>📚 Físico</option>
                        </select>
                    </div>
                    <div style="margin-bottom:12px;">
                        ...
                        <input type="text" name="area_tematica" value="<?php echo e(old('area_tematica', $recurso->area_tematica)); ?>"
                ...
                <div class="admin-card" style="margin-bottom:16px;">
                    ...
                    <div style="margin-bottom:12px;">
                        ...
                        <select name="activo" class="admin-input">
                            <option value="1" <?php echo e(old('activo', $recurso->activo)=='1' || old('activo', $recurso->activo)===true ?'selected':''); ?>>Publicado</option>
                            <option value="0" <?php echo e(old('activo', $recurso->activo)=='0' || old('activo', $recurso->activo)===false ?'selected':''); ?>>Oculto</option>
                        </select>
                    </div>
                    <div style="margin-bottom:14px;">
                        <label style="display:flex;align-items:center;gap:8px;font-size:13px;font-weight:500;color:var(--dark);cursor:pointer;">
                            <input type="hidden" name="destacado" value="0">
                            <input type="checkbox" name="destacado" value="1" <?php echo e(old('destacado', $recurso->destacado) ? 'checked' : ''); ?>>
                    ...
                    <div style="margin-bottom:14px;">
                        <label style="display:flex;align-items:center;gap:8px;font-size:13px;font-weight:500;color:var(--dark);cursor:pointer;">
                            ...
                            <input type="checkbox" name="descarga_permitida" value="1" <?php echo e(old('descarga_permitida', $recurso->descarga_permitida) ? 'checked' : ''); ?>>>
                    ...
                    <div>
                        <label style="display:flex;align-items:center;gap:8px;font-size:13px;font-weight:500;color:var(--dark);cursor:pointer;">
                            ...
                            <input type="checkbox" name="solo_colegiados" value="1" <?php echo e(old('solo_colegiados', $recurso->solo_colegiados) ? 'checked' : ''); ?>>>
                ...
                <div class="admin-card" style="margin-bottom:16px;">
                    ...
                    <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;">
                        <div style="text-align:center;padding:12px;background:var(--light-gray);border-radius:8px;">
                            <div style="font-size:22px;font-weight:800;color:var(--primary);"><?php echo e(number_format($recurso->vistas_count)); ?></div>
                            <div style="font-size:11px;color:var(--medium-gray);font-weight:600;">Vistas</div>
                        </div>
                        <div style="text-align:center;padding:12px;background:var(--light-gray);border-radius:8px;">
                            <div style="font-size:22px;font-weight:800;color:var(--secondary);"><?php echo e(number_format($recurso->descargas_count)); ?></div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\cpap-web\resources\views/admin/biblioteca/edit.blade.php ENDPATH**/ ?>