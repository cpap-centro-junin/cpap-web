<?php $__env->startSection('title', 'Página No Encontrada - CPAP'); ?>
<?php $__env->startSection('seo_title', 'Página No Encontrada | CPAP Región Centro'); ?>
<?php $__env->startSection('seo_description', 'La página que buscas no existe. Descubre más contenido del Colegio de Antropólogos del Perú.'); ?>
        ...
        <div class="error-suggestions">
            ...
            <ul class="suggestion-list">
                <li class="suggestion-item">
                    <a href="<?php echo e(route('noticias.index')); ?>" class="suggestion-link">
                ...
                <li class="suggestion-item">
                    <a href="<?php echo e(route('eventos.index')); ?>" class="suggestion-link">
                ...
                <li class="suggestion-item">
                    <a href="<?php echo e(route('colegiados.index')); ?>" class="suggestion-link">
                ...
                <li class="suggestion-item">
                    <a href="<?php echo e(route('colegiatura.index')); ?>" class="suggestion-link">
                ...
                <li class="suggestion-item">
                    <a href="<?php echo e(route('biblioteca')); ?>" class="suggestion-link">
                ...
                <li class="suggestion-item">
                    <a href="<?php echo e(route('bolsa-trabajo')); ?>" class="suggestion-link">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laravel\CPAP\cpap-web\resources\views/errors/404.blade.php ENDPATH**/ ?>