<?php $__env->startSection('title', 'Gestión de Inicio'); ?>
<?php $__env->startSection('page-title', 'Gestión de Inicio'); ?>
...
<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(300px,1fr));gap:24px;margin-bottom:32px;">
    ...
    <!-- Banner Slider -->
    <a href="<?php echo e(route('admin.inicio.slides.index')); ?>" 
        ...
        <div style="display:flex;align-items:center;justify-content:space-between;padding-top:16px;border-top:1px solid #f0f0f0;">
            <div style="display:flex;gap:12px;">
                <span style="background:rgba(76,175,80,0.12);color:#2E7D32;padding:4px 10px;border-radius:20px;font-size:12px;font-weight:600;">
                    <i class="fas fa-check-circle" style="font-size:10px;"></i> <?php echo e($slides->where('activo', true)->count()); ?> activas
                </span>
    ...
    <!-- Título y Botones -->
    <a href="<?php echo e(route('admin.inicio.hero.edit')); ?>" 
       style="display:block;background:white;border:2px solid #e3e3e3;border-radius:var(--radius);padding:28px;text-decoration:none;box-shadow:0 2px 8px rgba(0,0,0,0.06);transition:all 0.3s ease;"
    ...
    <!-- Números y Cifras -->
    <a href="<?php echo e(route('admin.inicio.estadisticas.edit')); ?>" 
       style="display:block;background:white;border:2px solid #e3e3e3;border-radius:var(--radius);padding:28px;text-decoration:none;box-shadow:0 2px 8px rgba(0,0,0,0.06);transition:all 0.3s ease;"
       ...
       onmouseout="this.style.transform='translateY(0)';this.style.boxShadow='0 2px 8px rgba(0,0,0,0.06)';this.style.borderColor='#e3e3e3'">
        ...
        <div style="display:flex;align-items:center;justify-content:space-between;padding-top:16px;border-top:1px solid #f0f0f0;">
            <div style="font-size:12px;color:var(--medium-gray);">
                <strong style="color:#4CAF50;font-size:18px;margin-right:6px;"><?php echo e($config->stat_colegiados); ?></strong>colegiados
                <span style="margin:0 8px;color:#ddd;">•</span>
                <strong style="color:#4CAF50;font-size:18px;margin-right:6px;"><?php echo e($config->stat_años); ?></strong>años
            </div>
    ...
    <!-- Anuncios Emergentes -->
    <a href="<?php echo e(route('admin.inicio.anuncios.index')); ?>" 
       style="display:block;background:white;border:2px solid #e3e3e3;border-radius:var(--radius);padding:28px;text-decoration:none;box-shadow:0 2px 8px rgba(0,0,0,0.06);transition:all 0.3s ease;"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\cpap-web\resources\views/admin/inicio/index.blade.php ENDPATH**/ ?>