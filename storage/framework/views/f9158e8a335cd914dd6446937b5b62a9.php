<?php $__env->startSection('title', 'Acceso Prohibido - CPAP'); ?>
<?php $__env->startSection('seo_title', 'Acceso Prohibido | CPAP Región Centro'); ?>
<?php $__env->startSection('seo_description', 'No tienes permiso para acceder a este recurso.'); ?>
    ...
    <div class="error-content">
        ...
        <div class="error-info">
            ...
            <p class="error-info-text">
                Si tienes dudas sobre permisos o acceso, puedes <a href="<?php echo e(route('contacto.index')); ?>" style="color: var(--primary, #8B1438); font-weight: 600; text-decoration: none;">contactarnos</a> para obtener más información.
            </p>
        </div>
    </div>
</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\cpap-web\resources\views/errors/403.blade.php ENDPATH**/ ?>