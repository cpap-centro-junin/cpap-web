<?php $__env->startSection('title', 'Contacto | Colegio de Antropólogos del Perú'); ?>
<?php $__env->startSection('seo_title', 'Contacto - Colegio de Antropólogos del Perú Región Centro | Huancayo'); ?>
<?php $__env->startSection('seo_description', 'Contacta al Colegio de Antropólogos del Perú - Región Centro. Dirección: Jr. Loreto 363, Huancayo. WhatsApp: 943 667 317. Email: cpap.rc@gmail.com. Atención de colegiatura y habilitación.'); ?>
<?php $__env->startSection('seo_keywords', 'contacto colegio antropólogos, CPAP huancayo teléfono, colegio antropólogos dirección, contacto CPAP región centro, antropólogos junín contacto'); ?>
<?php $__env->startSection('seo_canonical', route('contacto.index')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\cpap-web\resources\views/contacto/index.blade.php ENDPATH**/ ?>