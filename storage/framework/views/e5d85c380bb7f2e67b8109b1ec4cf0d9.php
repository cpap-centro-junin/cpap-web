...
<td align="center" style="background:linear-gradient(135deg,#7b1e3a,#4a0f23); padding:25px;">
    <img src="<?php echo e(url('images/logos/cpap-logo.jpg')); ?>" width="70"
         alt="CPAP Logo"
         width="70"
...
<td style="padding:8px 0;"><?php echo e($messageData->nombre); ?></td>
</tr>

<tr>
<td style="padding:8px 0;"><strong>Email:</strong></td>
<td style="padding:8px 0;"><?php echo e($messageData->email); ?></td>
</tr>

<tr>
<td style="padding:8px 0;"><strong>Teléfono:</strong></td>
<td style="padding:8px 0;"><?php echo e($messageData->telefono ?? 'No proporcionado'); ?></td>
</tr>

<tr>
<td style="padding:8px 0;"><strong>Asunto:</strong></td>
<td style="padding:8px 0;"><?php echo e($messageData->asunto); ?></td>
</tr>
</table>
...
<?php echo e($messageData->mensaje); ?>
...
<?php /**PATH C:\laragon\www\cpap-web\resources\views/emails/contact-message.blade.php ENDPATH**/ ?>