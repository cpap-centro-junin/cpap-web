...
<?php $__env->startSection('title', 'Política de Privacidad - CPAP Región Centro'); ?>
<?php $__env->startSection('description', 'Política de privacidad y protección de datos del Colegio de Antropólogos del Perú - Región Centro'); ?>
    ...
    <div class="legal-content">
        ...
        <section class="legal-section" style="margin-bottom: 40px;">
            ...
            <p style="margin-top: 20px; color: var(--medium-gray); font-size: 0.9rem;">
                <strong>Última actualización:</strong> <?php echo e(date('d de F de Y', strtotime('2026-04-14'))); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\cpap-web\resources\views/legal/privacidad.blade.php ENDPATH**/ ?>