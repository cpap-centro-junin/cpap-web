<?php $__env->startSection('title', 'Subir Documento de Habilitación'); ?>
<?php $__env->startSection('page-title', 'Generar Documento de Habilitación'); ?>
...
<div class="admin-container">
    ...
    <div class="breadcrumb">
        ...
        <span>/</span>
        <a href="<?php echo e(route('admin.colegiados.show', $colegiado)); ?>">
        ...
        <div class="colegiado-banner__info">
            ...
            <div class="colegiado-banner__meta">
                ...
                <?php if($colegiado->especialidad): ?>
                    ...
                    <span><?php echo e($colegiado->especialidad); ?></span>
                <?php endif; ?>
            </div>
        ...
        <div class="alert alert-warning">
            ...
            <div>
                ...
                <div style="margin-top: 6px; font-size: 13px;">
                    Código actual: <code><?php echo e($habilitacionActual->codigo_verificacion); ?></code>
                </div>
            </div>
        </div>
    <?php endif; ?>
    ...
    <div class="form-card">
        <form action="<?php echo e(route('admin.habilitaciones.store', $colegiado)); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            ...
            <div class="form-section">
                ...
                <div class="upload-container">
                    ...
                    <input
                        ...
                        name="documento"
                        id="documento"
                        class="upload-input <?php $__errorArgs = ['documento'];
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\cpap-web\resources\views/admin/habilitaciones/create.blade.php ENDPATH**/ ?>