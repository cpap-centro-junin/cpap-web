    ...
    <div class="admin-table-wrapper">
        <table>
            ...
            <tbody>
                ...
                <tr class="slide-row" data-slide-id="<?php echo e($slide->id); ?>">
                    <td style="text-align:center;">
                        <input type="checkbox" class="slide-checkbox" value="<?php echo e($slide->id); ?>" style="width:18px;height:18px;cursor:pointer;">
                    </td>
...
function executeBulkAction(action) {
    ...
    fetch('<?php echo e(route("admin.inicio.slides.bulk-toggle")); ?>', {
        method: 'POST',
        headers: {
